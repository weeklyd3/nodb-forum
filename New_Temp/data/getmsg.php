...
?>
	...
	<div>Post options:
		<ul class="flex options">
			<?php
		if ($message->author === getname() || verifyAdmin()) {
			?><li>
				<a href="edit_post.php?topic=<?php echo $esname; ?>&post=<?php echo $espost; ?>"><img src="img/icons/PencilIcon.png" alt="" /> Edit</a>
			</li>
			<li><a href="deletionmgrpost.php?topic=<?php echo $esname; ?>&post=<?php echo $espost; ?>"><img src="img/icons/XIcon.png" alt="" /> Manage Deletion</a></li>
			<?php
		}
		if ($message->author === getname()) { 
			...
			<li>
				<a href="revisions.php?topic=<?php echo $esname; ?>&post=<?php echo $espost; ?>"><img src="img/icons/RevisionsIcon.png" /> View <?php echo isset($message->revisions) ? count($message->revisions) : 1; ?> revision(s)</a></li>
		</ul></div>
	</li><?php
	}
	?></ul><?php
