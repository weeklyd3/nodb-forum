...
foreach ($revisions as $number => $revision) {
	...
	<h3>Page at this time</h3>
		<div class="smaller box"><?php echo $Parsedown->text($revision->contents); ?></div>
		<h3>Page source at this time</h3>
		<pre class="smaller box markdown"><code style="display: block;"><?php echo htmlspecialchars($revision->contents); ?></code></pre>
	</details></li><?php
}
?></ul>