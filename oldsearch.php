  ...
  <?php 
		...
		foreach ($stuff as $key => $entry) {
			...
			if ((!empty($name->title) && 
				...
				echo '<tr><td style="background:white;color:black;border-radius:3px;"><h3><a href="webchat.php?room='.urlencode(htmlspecialchars($name->title)).'">'.htmlspecialchars($name->title)."</a>";
